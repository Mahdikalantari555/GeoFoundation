...
- [ ] Task 1: Hierarchical key resolution
...
- [ ] Task 2: Weight transfer on first sub-region access
...
- [ ] Task 3: Schema migration for sub_region column
