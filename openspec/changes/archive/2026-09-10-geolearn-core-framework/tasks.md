...
- [x] Task 1: Scaffold library structure
...
- [x] Task 2: EmbeddingCache implementation
...
- [x] Task 3: OnlineClassifier wrapper
...
- [x] Task 5: ClassifierStore (per-key management)
...
- [x] Task 6: Integration test + public API surface
