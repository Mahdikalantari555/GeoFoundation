...
- [x] Task 1: Add ClassifierChoice enum and factory
...
- [x] Task 2: PassiveAggressiveClassifier wrapper
...
- [x] Task 3: IncrementalKMeans wrapper
...
- [x] Task 4: Backward-compatibility check
