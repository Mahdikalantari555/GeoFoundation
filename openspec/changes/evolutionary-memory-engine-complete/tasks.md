...
- [ ] Task 2: CandidateMemoryRepository state-transition tests
...
- [ ] Task 3: Promotion-pipeline integration test
...
- [ ] Task 4: Suggest-correction server endpoint
...
- [ ] Task 6: Register change under openspec
