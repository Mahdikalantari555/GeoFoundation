...
- [ ] Task 1: Add `pylancedb` optional extra
...
- [ ] Task 3: Unified `StorageBackend` interface
...
- [ ] Task 4: Change default `vector_backend`
...
- [ ] Task 5: AssetLayout abstraction
...
- [ ] Task 6: Wire AssetLayout into Workspace
