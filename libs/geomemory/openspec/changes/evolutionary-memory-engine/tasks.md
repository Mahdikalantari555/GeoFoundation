...
- [x] Task 1: Candidate Memory models + schema
...
- [x] Task 2: CandidateMemoryService + state transitions
...
- [x] Task 4: Promotion pipeline (feedback → candidate → scored)
...
- [x] Task 5: Change Proposal engine
...
- [x] Task 7: Web Feedback & Review UI
...
- [x] Task 8: Retrieval integration
