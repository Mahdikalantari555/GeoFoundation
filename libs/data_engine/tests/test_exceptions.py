...
class TestMETRICError:
    ...
    def test_error_creation(self):
        ...
        from data_engine.utils.exceptions import METRICError
...
class TestDataInputError:
    ...
    def test_data_input_error(self):
        ...
        from data_engine.utils.exceptions import DataInputError
    ...
    def test_scene_path_error(self):
        ...
        from data_engine.utils.exceptions import ScenePathError
...
class TestCalibrationError:
    ...
    def test_calibration_error(self):
        ...
        from data_engine.utils.exceptions import CalibrationError
...
class TestComputationError:
    ...
    def test_computation_error(self):
        ...
        from data_engine.utils.exceptions import ComputationError
...
class TestOutputError:
    ...
    def test_output_error(self):
        ...
        from data_engine.utils.exceptions import OutputError
...
class TestErrorHandlingUtilities:
    ...
    def test_handle_exception_decorator(self):
        ...
        from data_engine.utils.exceptions import handle_exception, ComputationError
    ...
    def test_handle_exception_file_not_found(self):
        ...
        from data_engine.utils.exceptions import handle_exception, DataInputError
    ...
    def test_create_error_context(self):
        ...
        from data_engine.utils.exceptions import METRICError, create_error_context
...
class TestExceptionHierarchy:
    ...
    def test_exception_inheritance(self):
        ...
        from data_engine.utils.exceptions import (
            METRICError,
            DataInputError,
            CalibrationError,
            ComputationError,
    ...
    def test_exception_catching(self):
        ...
        from data_engine.utils.exceptions import METRICError, DataInputError
